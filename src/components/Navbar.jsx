...
function Navbar() {
    ...
    return (
        <nav className="bg-black/80 backdrop-blur-sm flex justify-between items-center text-base py-4 px-16 font-medium fixed top-0 w-full z-50 border-b border-white/5">
            <a href="/" onClick={scrollTop} className="text-xl font-bold">
                9nickss
            </a>
